...
public class DegreeSeekBar extends View {
    ...
    private void init() {
        mPointColor = ContextCompat.getColor(getContext(), R.color.photos_fg_primary);
        mTextColor = ContextCompat.getColor(getContext(), R.color.photos_fg_primary);
        mCenterTextColor = ContextCompat.getColor(getContext(), R.color.photos_fg_accent);
