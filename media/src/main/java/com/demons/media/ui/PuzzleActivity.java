...
import com.demons.media.models.puzzle.Area;
import com.demons.media.models.puzzle.DegreeSeekBar;
import com.demons.media.models.puzzle.PuzzleLayout;
import com.demons.media.models.puzzle.PuzzlePiece;
import com.demons.media.models.puzzle.PuzzleUtils;
import com.demons.media.models.puzzle.PuzzleView;
import com.demons.media.models.sticker.StickerModel;
import com.demons.media.setting.Setting;
import com.demons.media.ui.adapter.PuzzleAdapter;
import com.demons.media.ui.adapter.TextStickerAdapter;
import com.demons.media.utils.bitmap.SaveBitmapCallBack;
...
public class PuzzleActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onClick(View view) {
        ...
        if (R.id.tv_back == id) {
            ...
            toggleIvMenu(R.id.iv_replace);
            if (null == toClass) {
                Gallery.createAlbum(this, true, false, Setting.imageEngine).setCount(1).start(91);
            } else {
            ...
            tvTemplate.setTextColor(ContextCompat.getColor(this, R.color.photos_fg_accent));
            ...
            tvTextSticker.setTextColor(ContextCompat.getColor(this, R.color.photos_fg_accent));
            tvTemplate.setTextColor(ContextCompat.getColor(this, R.color.photos_fg_primary));
        ...
        stickerModel.save(this, mRootView, puzzleView, puzzleView.getWidth(),
                ...
                new SaveBitmapCallBack() {
                    ...
                    public void onSuccess(File file) {
                        ...
                        intent.putExtra(Gallery.RESULT_PHOTOS, photo);
    ...
    private void toggleIvMenu(@IdRes int resId) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (ivMenu.getId() == resId) {
                ivMenu.setColorFilter(ContextCompat.getColor(this, R.color.photos_fg_accent));
            } else {
        ...
        switch (resultCode) {
            case RESULT_OK:
                ...
                ArrayList<Photo> photos =
                        data.getParcelableArrayListExtra(Gallery.RESULT_PHOTOS);
