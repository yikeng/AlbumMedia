...
import com.demons.media.models.puzzle.SquarePuzzleView;
import com.demons.media.models.puzzle.template.slant.NumberSlantLayout;
import com.demons.media.models.puzzle.template.straight.NumberStraightLayout;
...
public class PuzzleAdapter extends RecyclerView.Adapter<PuzzleAdapter.PuzzleViewHolder> {
    ...
    public PuzzleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_puzzle_photos, parent, false);
